/* Service worker â€” network-first dengan fallback cache (offline support) */
var CACHE = 'ftg-v61';
var CORE = [
  ...
  'app.js?v=89', 'responsive.css?v=82', 'tailwind-static.css?v=1', 'ftg-config.js?v=30', 'manifest.json',
