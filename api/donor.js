...
function defaultPortal(programName) {
  return {
    ...
    programs:[{
      ...
      finance:{ currency:'IDR', contribution:100000000, spent:82000000, social_value:470000000, verified:false, note:'Angka awal dari rancangan donor; Fasil wajib memverifikasi sebelum publikasi.', note_en:'Initial dashboard figures; Fasil verification is required before publication.' },
